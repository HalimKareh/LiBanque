			...
			<div class="col-md-12 no-float" id="web-body">
				<div class="row">
					...
					<div class="col-xs-12">
						...
						<%
							...
							if (message != null) {
								if (message.equals("1")) {
									...
									out.write(" Success: Type Account updated. <a href=\"edit_delete.jsp\">Click Here</a> to go back!");
									out.write("</div>");
								}
								if (message.equals("0")) {
						...
						%>
						<%String typeAccountId = request.getParameter("typeAccountId"); 
						TypeAccount typeAccount = Services.findTypeAccoundById(typeAccountId);
						%>
						<form action="UpdateTypeAccount" method="post">
							<input type="hidden" name="typeId" value="<%=typeAccountId%>">
							<div class="form-group">
							
								<label>Name</label> <input type="text"
									placeholder="Enter Type Here.." class="form-control"
									name="type" required value="<%= typeAccount.getName() %>">
							</div>
